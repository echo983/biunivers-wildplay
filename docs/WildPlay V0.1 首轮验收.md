...
2026-07-29 使用真实 MKV 文件完成容器探测、播放、音频、进度跳转和全屏测试，结果正常。
WebM 保持 Manifest 声明和 Mediabunny 输入支持，但不再作为 V0.1 人工验收门槛。
...
这些项目不否定 MP4/MKV 点播主链路的可用性。WebM 属于尽力支持格式，不作 V0.1
已实测承诺。
